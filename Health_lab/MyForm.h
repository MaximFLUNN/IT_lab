...
namespace Healthlab {
	...
	/// Сводка для MyForm
	/// </summary>
	COM_controller com_controller = COM_controller();
	std::wstring connected_port;
...
private: System::Windows::Forms::Label^ pwarningAllPart2;
	...
	private: System::Windows::Forms::Label^ warningLabelGraphics;
	private: System::Windows::Forms::TextBox^ graphicLabel;
	...
	private: System::Windows::Forms::PictureBox^ bpGalka;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->GraphicPanel = (gcnew System::Windows::Forms::Panel());
			this->bpGalka = (gcnew System::Windows::Forms::PictureBox());
			...
			this->warningLabelGraphics = (gcnew System::Windows::Forms::Label());
			this->graphicLabel = (gcnew System::Windows::Forms::TextBox());
			this->pictureBox2 = (gcnew System::Windows::Forms::PictureBox());
			this->btnSolve2 = (gcnew System::Windows::Forms::Button());
			this->pbCrest = (gcnew System::Windows::Forms::PictureBox());
			this->ConnectionTimer = (gcnew System::Windows::Forms::Timer(this->components));
			...
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^>(this->bpGalka))->BeginInit();
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^>(this->Chart))->BeginInit();
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^>(this->pictureBox2))->BeginInit();
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^>(this->pbCrest))->BeginInit();
			this->SuspendLayout();
			// 
			// Exit_1
			// 
			...
			// GraphicPanel
			// 
			this->GraphicPanel->Controls->Add(this->bpGalka);
			this->GraphicPanel->Controls->Add(this->Chart);
			this->GraphicPanel->Controls->Add(this->ConnectionLabel);
			this->GraphicPanel->Controls->Add(this->label9);
			this->GraphicPanel->Controls->Add(this->warningLabelGraphics);
			this->GraphicPanel->Controls->Add(this->graphicLabel);
			this->GraphicPanel->Controls->Add(this->pictureBox2);
			this->GraphicPanel->Controls->Add(this->pbCrest);
			this->GraphicPanel->Controls->Add(this->btnSolve);
			this->GraphicPanel->Controls->Add(this->btnSolve2);
			resources->ApplyResources(this->GraphicPanel, L"GraphicPanel");
			this->GraphicPanel->Name = L"GraphicPanel";
			this->GraphicPanel->MouseDown += gcnew System::Windows::Forms::MouseEventHandler(this, &MyForm::MyForm_Transperent65);
			this->GraphicPanel->MouseMove += gcnew System::Windows::Forms::MouseEventHandler(this, &MyForm::MyForm_MouseMove1);
			this->GraphicPanel->MouseUp += gcnew System::Windows::Forms::MouseEventHandler(this, &MyForm::MyForm_Transperent100);
			// 
			// bpGalka
			// 
			resources->ApplyResources(this->bpGalka, L"bpGalka");
			this->bpGalka->Name = L"bpGalka";
			this->bpGalka->TabStop = false;
			// 
			// Chart
			// 
			this->Chart->BackColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(224)), static_cast<System::Int32>(static_cast<System::Byte>(224)),
				static_cast<System::Int32>(static_cast<System::Byte>(224)));
			resources->ApplyResources(this->Chart, L"Chart");
			this->Chart->BackImageTransparentColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)),
			...
			this->Chart->BackSecondaryColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(64)),
				static_cast<System::Int32>(static_cast<System::Byte>(64)));
			this->Chart->BorderlineColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(224)), static_cast<System::Int32>(static_cast<System::Byte>(224)),
				static_cast<System::Int32>(static_cast<System::Byte>(224)));
			this->Chart->BorderlineDashStyle = System::Windows::Forms::DataVisualization::Charting::ChartDashStyle::Solid;
			this->Chart->BorderSkin->BackColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)),
				static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(64)));
			this->Chart->BorderSkin->BackImageTransparentColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)),
				static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(64)));
			this->Chart->BorderSkin->BackSecondaryColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)),
				static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(64)));
			this->Chart->BorderSkin->BorderColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)),
				static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(64)));
			chartArea1->AxisX->LabelStyle->ForeColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)),
				static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(64)));
			chartArea1->AxisX->LineColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(64)),
				static_cast<System::Int32>(static_cast<System::Byte>(64)));
			chartArea1->AxisX->MajorGrid->LineColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)),
				static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(64)));
			chartArea1->AxisX->MajorTickMark->LineColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)),
				static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(64)));
			chartArea1->AxisX->MinorGrid->LineColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)),
				static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(64)));
			chartArea1->AxisX->MinorTickMark->LineColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)),
				static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(64)));
			chartArea1->AxisX->TitleForeColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(64)),
				static_cast<System::Int32>(static_cast<System::Byte>(64)));
			chartArea1->AxisX2->LabelStyle->ForeColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)),
				static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(64)));
			chartArea1->AxisX2->LineColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(64)),
				static_cast<System::Int32>(static_cast<System::Byte>(64)));
			chartArea1->AxisX2->MajorGrid->LineColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)),
				static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(64)));
			chartArea1->AxisX2->MajorTickMark->LineColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)),
				static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(64)));
			chartArea1->AxisX2->MinorGrid->LineColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)),
				static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(64)));
			chartArea1->AxisX2->MinorTickMark->LineColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)),
				static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(64)));
			chartArea1->AxisX2->TitleForeColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)),
				static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(64)));
			chartArea1->AxisY->LabelStyle->ForeColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)),
				static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(64)));
			chartArea1->AxisY->LineColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(64)),
				static_cast<System::Int32>(static_cast<System::Byte>(64)));
			chartArea1->AxisY->MajorGrid->LineColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)),
				static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(64)));
			chartArea1->AxisY->MajorTickMark->LineColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)),
				static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(64)));
			chartArea1->AxisY->MinorGrid->LineColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)),
				static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(64)));
			chartArea1->AxisY->MinorTickMark->LineColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)),
				static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(64)));
			chartArea1->AxisY->TitleForeColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(64)),
				static_cast<System::Int32>(static_cast<System::Byte>(64)));
			chartArea1->AxisY2->LabelStyle->ForeColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)),
				static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(64)));
			chartArea1->AxisY2->LineColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(64)),
				static_cast<System::Int32>(static_cast<System::Byte>(64)));
			chartArea1->AxisY2->MajorTickMark->LineColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)),
				static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(64)));
			chartArea1->AxisY2->MinorGrid->LineColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)),
				static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(64)));
			chartArea1->AxisY2->MinorTickMark->LineColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)),
				static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(64)));
			chartArea1->AxisY2->TitleForeColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)),
				static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(64)));
			chartArea1->BackColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(224)), static_cast<System::Int32>(static_cast<System::Byte>(224)),
				static_cast<System::Int32>(static_cast<System::Byte>(224)));
			chartArea1->BackImageTransparentColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)),
				static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(64)));
			...
			chartArea1->ShadowColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(64)),
				static_cast<System::Int32>(static_cast<System::Byte>(64)));
			this->Chart->ChartAreas->Add(chartArea1);
			legend1->BorderColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(64)),
				static_cast<System::Int32>(static_cast<System::Byte>(64)));
			legend1->Enabled = false;
			legend1->ForeColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(64)),
				static_cast<System::Int32>(static_cast<System::Byte>(64)));
			legend1->HeaderSeparatorColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(64)),
				static_cast<System::Int32>(static_cast<System::Byte>(64)));
			legend1->InterlacedRows = true;
			legend1->ItemColumnSeparatorColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(64)),
				static_cast<System::Int32>(static_cast<System::Byte>(64)));
			legend1->Name = L"Legend1";
			legend1->TitleForeColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(64)),
				static_cast<System::Int32>(static_cast<System::Byte>(64)));
			legend1->TitleSeparatorColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(64)),
				static_cast<System::Int32>(static_cast<System::Byte>(64)));
			this->Chart->Legends->Add(legend1);
			this->Chart->Name = L"Chart";
			this->Chart->Palette = System::Windows::Forms::DataVisualization::Charting::ChartColorPalette::Pastel;
			series1->BackImageTransparentColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)),
				static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(64)));
			series1->BackSecondaryColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(64)),
				static_cast<System::Int32>(static_cast<System::Byte>(64)));
			...
			series1->EmptyPointStyle->BackImageTransparentColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)),
				static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(64)));
			series1->EmptyPointStyle->BackSecondaryColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)),
				static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(64)));
			series1->EmptyPointStyle->BorderColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)),
				static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(64)));
			series1->EmptyPointStyle->Color = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(64)),
				static_cast<System::Int32>(static_cast<System::Byte>(64)));
			series1->EmptyPointStyle->LabelBackColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)),
				static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(64)));
			series1->EmptyPointStyle->LabelBorderColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)),
				static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(64)));
			series1->EmptyPointStyle->LabelForeColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)),
				static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(64)));
			series1->EmptyPointStyle->MarkerBorderColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)),
				static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(64)));
			series1->EmptyPointStyle->MarkerColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)),
				static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(64)));
			series1->IsVisibleInLegend = false;
			series1->LabelBackColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(64)),
				static_cast<System::Int32>(static_cast<System::Byte>(64)));
			series1->LabelBorderColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(64)),
				static_cast<System::Int32>(static_cast<System::Byte>(64)));
			series1->LabelForeColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(64)),
				static_cast<System::Int32>(static_cast<System::Byte>(64)));
			series1->Legend = L"Legend1";
			series1->MarkerBorderColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(64)),
				static_cast<System::Int32>(static_cast<System::Byte>(64)));
			series1->MarkerColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(64)),
				static_cast<System::Int32>(static_cast<System::Byte>(64)));
			series1->MarkerImageTransparentColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)),
				static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(64)));
			...
			this->Chart->MouseMove += gcnew System::Windows::Forms::MouseEventHandler(this, &MyForm::MyForm_MouseMove1);
			// 
			// btnSolve
			// 
			this->btnSolve->BackColor = System::Drawing::Color::Transparent;
			resources->ApplyResources(this->btnSolve, L"btnSolve");
			...
			this->btnSolve->ForeColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(5)), static_cast<System::Int32>(static_cast<System::Byte>(147)),
				static_cast<System::Int32>(static_cast<System::Byte>(255)));
			this->btnSolve->Name = L"btnSolve";
			this->btnSolve->UseVisualStyleBackColor = false;
			this->btnSolve->MouseEnter += gcnew System::EventHandler(this, &MyForm::btnIn_downh_Click);
			// 
			// ConnectionLabel
			// 
			resources->ApplyResources(this->ConnectionLabel, L"ConnectionLabel");
			...
			// 
			// warningLabelGraphics
			// 
			resources->ApplyResources(this->warningLabelGraphics, L"warningLabelGraphics");
			this->warningLabelGraphics->BackColor = System::Drawing::Color::Transparent;
			this->warningLabelGraphics->ForeColor = System::Drawing::Color::Red;
			this->warningLabelGraphics->Name = L"warningLabelGraphics";
			// 
			// graphicLabel
			// 
			this->graphicLabel->BackColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(191)), static_cast<System::Int32>(static_cast<System::Byte>(191)),
				static_cast<System::Int32>(static_cast<System::Byte>(191)));
			this->graphicLabel->BorderStyle = System::Windows::Forms::BorderStyle::None;
			resources->ApplyResources(this->graphicLabel, L"graphicLabel");
			this->graphicLabel->ForeColor = System::Drawing::SystemColors::WindowFrame;
			this->graphicLabel->Name = L"graphicLabel";
			this->graphicLabel->TabStop = false;
			// 
			// pictureBox2
			// 
			...
			resources->ApplyResources(this->btnSolve2, L"btnSolve2");
			this->btnSolve2->FlatAppearance->BorderSize = 0;
			this->btnSolve2->FlatAppearance->MouseDownBackColor = System::Drawing::Color::Transparent;
			this->btnSolve2->FlatAppearance->MouseOverBackColor = System::Drawing::Color::Transparent;
			this->btnSolve2->ForeColor = System::Drawing::SystemColors::Control;
			this->btnSolve2->Name = L"btnSolve2";
			this->btnSolve2->UseVisualStyleBackColor = false;
			this->btnSolve2->Click += gcnew System::EventHandler(this, &MyForm::updateGr);
			this->btnSolve2->MouseLeave += gcnew System::EventHandler(this, &MyForm::btnIn_uph_Click);
			// 
			// pbCrest
			// 
			resources->ApplyResources(this->pbCrest, L"pbCrest");
			this->pbCrest->Name = L"pbCrest";
			this->pbCrest->TabStop = false;
			// 
			// ConnectionTimer
			// 
			this->ConnectionTimer->Enabled = true;
			this->ConnectionTimer->Tick += gcnew System::EventHandler(this, &MyForm::ConnectionTimer_Tick);
			// 
			// MyForm
			// 
			...
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^>(this->bpGalka))->EndInit();
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^>(this->Chart))->EndInit();
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^>(this->pictureBox2))->EndInit();
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^>(this->pbCrest))->EndInit();
...
#pragma endregion
	...
	private: System::Void plus_Tick(System::Object^ sender, System::EventArgs^ e) {
		...
		btnSolve->Size = Reg_btn1->Size;
		btnSolve2->Size = Reg_btn1->Size;
		btnSolve->Location = Reg_btn1->Location;
		btnSolve->Location = Reg_btn1->Location;
		//btnSolve2->Location = Reg_btn1->Location;
		//btnSolve2->Location = Reg_btn1->Location;
		btnSolve->Location = Point(Reg_btn1->Location.X + 315, Reg_btn1->Location.Y - 375);
		btnSolve2->Location = Point(Reg_btn1->Location.X + 315, Reg_btn1->Location.Y - 375);
		//// Width
		//if (btnSolve->Size.Width < 234) {
		//	btnSolve->Size = System::Drawing::Size(btnSolve->Size.Width + 2, btnSolve->Size.Height);
		//}
		//// Height
		//if (btnSolve->Size.Height < 80) {
		//	btnSolve->Size = System::Drawing::Size(btnSolve->Size.Width, btnSolve->Size.Height + 1);
		//}
		//// X
		//if (btnSolve->Location.X > 1020) {
		//	btnSolve->Location = Point(btnSolve->Location.X - 1, btnSolve->Location.Y);
		//}
		//// Y
		//if (btnSolve->Location.Y > 21) {
		//	btnSolve->Location = Point(btnSolve->Location.X, btnSolve->Location.Y - 1);
		//}
		///////////////////////////////////////reg
	...
	private: System::Void minus_Tick(System::Object^ sender, System::EventArgs^ e) {
		...
		btnSolve->Size = btn1->Size;
		btnSolve2->Size = btn1->Size;
		btnSolve->Location = Reg_btn1->Location;
		btnSolve->Location = Reg_btn1->Location;
		//btnSolve2->Location = Reg_btn1->Location;
		//btnSolve2->Location = Reg_btn1->Location;
		...
		//// Width
		//if (btnSolve->Size.Width > 224) {
		//	btnSolve->Size = System::Drawing::Size(btnSolve->Size.Width - 2, btnSolve->Size.Height);
		//}
		//// Height
		//if (btnSolve->Size.Height > 75) {
		//	btnSolve->Size = System::Drawing::Size(btnSolve->Size.Width, btnSolve->Size.Height - 1);
		//}
		//// X
		//if (btnSolve->Location.X < 1025) {
		//	btnSolve->Location = Point(btnSolve->Location.X + 1, btnSolve->Location.Y);
		//}
		//// Y
		//if (btnSolve->Location.Y < 23) {
		//	btnSolve->Location = Point(btnSolve->Location.X, btnSolve->Location.Y + 1);
		//}
		////////////////////////////////////reg
	...
	private: System::Void updateGr(System::Object^ sender, System::EventArgs^ e) {
		com_controller.disconnect();
		com_controller.isConnected = false;
		com_controller.connect_to_esp32(connected_port.c_str());
		Chart->Series[0]->Points->Clear();
		warningLabelGraphics->Visible = false;
		double a = -10;
		double b = 10;
		double h = 0.1;
		double x = a;
		...
		while (x <= b) {
			std::string send_string = replaceX(String_to_string(graphicLabel->Text), std::to_string(x));
			com_controller.clearBuff();
			std::string get_solve = com_controller.solve(send_string);
			if (!get_solve.empty() && get_solve != "nan") {
				solve = std::stod(get_solve);
				Chart->Series[0]->Points->AddXY(x, solve);
			}
			else {
				if (get_solve == "nan") {
					warningLabelGraphics->Visible = true;
				}
				com_controller.disconnect();
				com_controller.connect_to_esp32(connected_port.c_str());
			}
	...
	std::string String_to_string(String^ string) {
	...
	std::string replaceX(std::string string, std::string x) {
		std::string new_string;
	...
	bool updateStateCOMs() {
		std::vector<std::wstring> tmpvec;
		tmpvec = com_controller.get_available_com_potrs();
		for (const auto& elem : tmpvec) {
			if (elem == connected_port) {
				return true;
			}
		}
		connected_port = L"";
	...
	String^ wstring_to_String(std::wstring string) {
		String^ new_string;
		int size = string.length();
		for (int i = 0; i < size; i++) {
			new_string += string[i];
	...
	private: System::Void ConnectionTimer_Tick(System::Object^ sender, System::EventArgs^ e) {
		if (!connected_port.empty()) { 
			if (com_controller.isConnected) {
				com_controller.isConnected = updateStateCOMs();
			}
			else {
				bpGalka->Visible = true;
				ConnectionLabel->Text = "Connected: " + "[" + wstring_to_String(connected_port) + "]";
				com_controller.connect_to_esp32(connected_port.c_str());
				com_controller.isConnected = true;
			}
		}
		else {
			bpGalka->Visible = false;
			ConnectionLabel->Text = "Connected: [FIND]";
			connected_port = com_controller.auto_find_port_esp32();
		}
	}
};
